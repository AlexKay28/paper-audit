# ML Reviewer Guidelines & Evaluation Criteria

**Source:** <https://github.com/PNemo04/My_skills/blob/main/skills/research-writing/ml-paper-writing/references/reviewer-guidelines.md>
**Fetched:** Aug 19, 2026

How reviewers evaluate papers at major ML/AI conferences, to help authors
anticipate and address reviewer concerns.

> For systems-conference reviewer guidelines (OSDI, NSDI, ASPLOS, SOSP), see the
> `systems-paper-writing` skill in the source repo.
...
> Papers that provide novel insights from evaluating existing approaches or
...
- Rejecting for missing citations to the reviewer's own work.
...
3. **Multilingual consideration** — If applicable, is language diversity
   addressed?
...
Acknowledge gracefully: "The reviewer is correct that... We will revise to..."
...
Frame disagreements constructively: "We appreciate this perspective. However,
[explanation]..."
